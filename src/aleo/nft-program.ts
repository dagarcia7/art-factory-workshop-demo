export const NFTProgramId = 'dennis-workshop-1.aleo';

export const NFTProgram = `program dennis-workshop-1.aleo;
...
function initialize_collection:
    ...
    output r3 as dennis-workshop-1.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as dennis-workshop-1.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as dennis-workshop-1.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as dennis-workshop-1.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as dennis-workshop-1.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as dennis-workshop-1.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as dennis-workshop-1.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as dennis-workshop-1.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as dennis-workshop-1.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as dennis-workshop-1.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as dennis-workshop-1.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as dennis-workshop-1.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as dennis-workshop-1.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as dennis-workshop-1.aleo/convert_public_to_private.future;
